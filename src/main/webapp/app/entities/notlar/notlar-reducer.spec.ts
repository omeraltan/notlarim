...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './notlar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTLAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTLAR actions', async () => {
      const expectedActions = [
        {
