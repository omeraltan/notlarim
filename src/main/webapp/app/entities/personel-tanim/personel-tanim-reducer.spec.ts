...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONELTANIM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONELTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONELTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONELTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONELTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONELTANIM actions', async () => {
      const expectedActions = [
        {
