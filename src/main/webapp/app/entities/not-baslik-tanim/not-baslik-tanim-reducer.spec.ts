...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTBASLIKTANIM_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTBASLIKTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTBASLIKTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTBASLIKTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTBASLIKTANIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTBASLIKTANIM actions', async () => {
      const expectedActions = [
        {
